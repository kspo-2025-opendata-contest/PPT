...
import { Database, Cpu, Trophy, ArrowRight, Zap, Network, ClipboardList } from 'lucide-react';
...
const AISlide: React.FC<SlideProps> = () => {
  return (
    <div className="h-full flex flex-col justify-center items-center px-4 overflow-hidden py-2">
      ...
      <div className="w-full max-w-[98%] flex flex-col md:flex-row items-stretch justify-center gap-6">
